...
public class TrackControllerTest {
    ...
    public void deleteTrackById() throws Exception {
        Track t1 = new Track(2, "taki-taki", "hiphop");
        when(trackService.getTrackById(anyInt())).thenReturn(track);
    ...
    public void getTrackByName() throws Exception {
        //Track t1 = new Track(2,"taki-taki","hiphop");
        when(trackService.getTrackByName(anyString())).thenReturn(track);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/trackname/taki-taki")
                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(track)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
